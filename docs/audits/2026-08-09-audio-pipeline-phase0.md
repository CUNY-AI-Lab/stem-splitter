...
- The reviewed committed lineage now reaches teacher-governance commit
  ...
  source-scope fix plus latest complete clean committed-source gate to
  `86cd50b`.
...
1. Review the clean `86cd50b` release scope, then publish the v3.2 branch for
