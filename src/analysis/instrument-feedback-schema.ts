/**
 * Candidate teacher feedback is application-append-only. Rows may be deleted
 * with their retained job, but they cannot be rewritten or promoted in place.
 * A separately reviewed and de-identified artifact is required before any
 * observation can become training/evaluation ground truth.
 */
export const INSTRUMENT_DISCOVERY_FEEDBACK_SCHEMA_SQL = `
